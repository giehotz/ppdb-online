...
<div class="p-4 md:p-8 lg:p-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-cyan-100 p-6 flex flex-col items-start transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <div class="mt-4 flex flex-col items-start space-y-2">
                ...
                <a href="/student/documents" class="inline-flex items-center font-medium text-green-600 hover:text-green-800 transition-colors">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-yellow-100 p-6 flex flex-col items-start transition-all hover:shadow-xl hover:-translate-y-1">
            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-yellow-50 text-yellow-600 font-bold mb-3">
            ...
            <?php if (isset($student) && $student && isset($submission) && $submission): ?>
                <?php if ($student['submission_state'] === 'draft'): ?>
                    <button id="submitRegistrationBtn" class="mt-4 inline-flex items-center font-medium text-yellow-600 hover:text-yellow-800 transition-colors">
                        <i class="fas fa-paper-plane mr-2 text-sm"></i>
                        Ajukan Sekarang
                    </button>
                <?php else: ?>
                    <span class="mt-4 inline-flex items-center text-gray-500 text-sm">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-green-100 p-6 flex flex-col items-start transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <?php if (isset($student) && $student && isset($submission) && $submission): ?>
                <?php if (in_array($submission['status'], ['terverifikasi', 'diterima', 'cadangan'])): ?>
                    <a href="/student/print-registration" class="mt-4 inline-flex items-center font-medium text-green-600 hover:text-green-800 transition-colors">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 mb-8">
        <div class="p-6 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="/announcement" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition">
                            <div class="flex justify-between">
                                <h4 class="font-medium text-gray-900">
                                    <a href="/announcement/<?= $announcement['id'] ?>" class="hover:text-indigo-600">
                            ...
                            <div class="mt-2 text-gray-600 text-sm">
                                <?= esc(substr(strip_tags($announcement['content']), 0, 100)) ?>...
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
