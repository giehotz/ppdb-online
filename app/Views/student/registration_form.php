...
<div class="mt-4 px-6 py-4 bg-white rounded-lg shadow border-b">
    <div class="flex justify-between items-center">
...
<!-- Menambahkan pustaka SweetAlert -->
...
<script>
        ...
        fetch("/student/save-draft", {
            ...
            .then(data => {
                if (data.status === "success") {
                    ...
                    // Tampilkan SweetAlert untuk pesan error dari server
                    Swal.fire({
                        icon: 'error',
            ...
            .catch(error => {
                ...
                // Tampilkan SweetAlert jika ada kesalahan jaringan
                Swal.fire({
                    icon: 'error',
    ...
    function submitForm() {
        Swal.fire({
            ...
            text: "Pastikan semua data telah diisi dengan benar. Formulir yang sudah diajukan tidak dapat diubah.",
            icon: 'warning',
