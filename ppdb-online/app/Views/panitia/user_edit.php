    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <nav class="text-sm text-gray-500">
                ...
                <a href="/panitia/users">Manajemen Pengguna</a> / Edit Pengguna
            </nav>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow p-6">
    <form action="/panitia/users/update/<?= $user['id'] ?>" method="POST">
        <?= csrf_field() ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="username" id="username" value="<?= old('username', $user['username']) ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>

            <div>
                <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                <input type="email" name="email" id="email" value="<?= old('email', $user['email']) ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <input type="password" name="password_confirm" id="password_confirm" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
